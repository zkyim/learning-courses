                ...
                <div class="settings-page m-20 d-grid gap-20">
                    ...
                    <form action="#">
                      ...
                      <div class="d-flex block-mobile gap-20">
                        <div class="mb-15 w-full">
                          <input class="b-none border-ccc p-10 rad-6 d-block w-full" type="text" name="FName" placeholder="الاسم الأول" value="<?php echo $infoUser['FName']; ?>"/>
                        </div>
                        <div class="mb-15 w-full">
                          <input class="b-none border-ccc p-10 rad-6 d-block w-full" type="text" name="SName" placeholder="إسم الأب" value="<?php echo $infoUser['SName']; ?>"/>
                        </div>
                      </div>
                      <div class="mb-15">
                        <input class="b-none border-ccc p-10 rad-6 d-block w-full" type="email" name="Email" placeholder="البريد الإلكتروني" value="<?php echo $infoUser['Email']; ?>"/>
                      </div>
                      <div class="mb-15">
                        <input class="b-none border-ccc p-10 rad-6 d-block w-full" type="number" name="phoneNumber" placeholder="رقم الهاتف" value="<?php echo $infoUser['PhoneNumber']; ?>"/>
                      </div>
                  ...
                  <div class="social-boxes p-20 bg-white rad-10">
                    ...
                    <form>
                      ...
                      <div class="d-flex align-center mb-15">
                        ...
                        <input class="w-full" name="twitter" type="url" placeholder="رابط تويتر" value="<?php echo $infoUser['Twitter']; ?>"/>
                      </div>
                      <div class="d-flex align-center mb-15">
                        <i class="fa-brands fa-facebook-f center-flex c-grey"></i>
                        <input class="w-full" name="facebook" type="url" placeholder="رابط فيس بوك" value="<?php echo $infoUser['Facebook']; ?>" />
                      </div>
                      <div class="d-flex align-center mb-15">
                        <i class="fa-brands fa-linkedin center-flex c-grey"></i>
                        <input class="w-full" name="linkedin" type="url" placeholder="رابط لينكد إن" value="<?php echo $infoUser['Linkedin']; ?>" />
                      </div>
                      <div class="d-flex align-center mb-15">
                        <i class="fa-brands fa-youtube center-flex c-grey"></i>
                        <input class="w-full" name="youtube" type="url" placeholder="رابط اليوتيوب" value="<?php echo $infoUser['Youtube']; ?>" />
                      </div>
                  ...
                  <div class="p-20 bg-white rad-10">
                    ...
                    <div class="sec-box mb-15 between-flex">
                        <div>
                            <span>كلمة السر</span>
                            <p class="c-grey mt-5 mb-0 fs-13"> <?php if ($infoUser['LastChahgePassDate'] == '0000-00-00') {echo 'لم تقم بتعديل كلمة السر منذ إنشاء الحساب.';}else {echo 'آخر تعديل كان في '.$infoUser['LastChahgePassDate'].'';} ?></p>
                          </div>
