    ...
    <div class="page d-flex">
      <div class="sidebar bg-white p-20 p-relative <?php if (isset($_COOKIE['style']['designlinks'])) {if($_COOKIE['style']['designlinks']=='hidelinks'){echo'hide';}elseif($_COOKIE['style']['designlinks']!='sidelinks'){echo 'close';}} ?>">
        ...
        <ul>
          ...
          <a href="members.php">
            <li  class="<?php setActive ('members') ?> d-flex align-center fs-14 c-black rad-6 p-10">
          ...
          <a href="mangecourse.php">
            <li  class="<?php setActive ('mangecourse') ?> d-flex align-center fs-14 c-black rad-6 p-10">
            ...
            <!-- <li class="menu">
              ...
              <div class="menu">
                <a href="mangecourse.php">قدرات</a>
                <a href="mangecourse.php">تحصيلي</a>
              </div>
            </li> -->
